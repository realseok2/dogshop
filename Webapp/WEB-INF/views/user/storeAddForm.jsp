  ...
  <div class="container">
	...
	<!-- /user-aside-->
      ...
      <div class="col-md-10 order-md-2">
        <h4 class="center-block text-center"><img class="signinLogo pb-5" src="${pageContext.request.contextPath}/assets/image/lettering-dark.png" alt="Logo" width="200"><br>매장 등록</h4>
        ...
        <form id="storeAdd-center" class="needs-validation center-block" novalidate action="${pageContext.request.contextPath}/user/storeAdd" method="post" enctype="multipart/form-data">
          <div class="row">
            ...
            <div id="div-center" class="col-md-5 mb-3">
              ...
              <input type="text" class="form-control" id="shopDomain" placeholder="사용 할 도메인 주소를 입력해 주세요." required name="shopDomain" value="">
              <div class="invalid-feedback">도메인 주소를 입력해주세요.</div>
            </div>
          ...
          <div class="row">
            <div id="div-center" class="col-md-5 mb-3">
              ...
              <input type="text" class="form-control" id="shopAddr" placeholder="매장의 주소를 입력해 주세요." required name="shopAddress">
              <div class="invalid-feedback">매장 주소를 입력해 주세요.</div>
            </div>
          </div>
          ...
          <div class="row">
            <div id="div-center" class="col-md-5 mb-3">
              ...
              <div class="invalid-feedback">매장의 이메일 주소를 입력해 주세요.</div>
            </div>
          </div>
          ...
          <div class="row">
            <div id="div-center" class="col-md-5 mb-3">
              ...
              <div class="invalid-feedback">사업자 번호를 입력해 주세요.</div>
            </div>
          </div>
